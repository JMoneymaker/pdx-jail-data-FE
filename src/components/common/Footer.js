  ...
  return (
    <footer className={styles.Footer}>
      <div className={styles.footerContent}>
        ...
        <p>
        The PDX Jail Data Dashboard was created for public information purposes by compiling and displaying key population data for persons jailed in the Portland Metro Area. 
        </p>
        <p>
